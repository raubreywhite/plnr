...
plnr looks up a name when the analysis runs. You can therefore define or change the function after you add the analysis. It looks first where you called `add_analysis()`, then in the global environment and on the search path, and last in plnr itself. `"pkg::fn"` names a function that a package exports. `?get_anything` gives the full order.
